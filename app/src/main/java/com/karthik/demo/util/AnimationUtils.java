...
//        animatorSet.start();
    ...
    public static void animateScatter(RecyclerView.ViewHolder holder, boolean goesDown) {
        ...
        AnimatorSet animatorSet = new AnimatorSet();
        ObjectAnimator animatorTranslateY = ObjectAnimator.ofFloat(holderItemView, "translationY", goesDown == true ? 200 : -200, 0);
...
//        animatorSet.start();
    ...
    public static void slideLeft(View view) {
        ...
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(view, "translationX", -1000,70,1);
    ...
    public static void flip(View view) {
        ...
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(view, "rotationX", 0.0f,360f);
    ...
    public static void fadeOut(View view) {
        ...
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(view, View.ALPHA, 1,0);
